...
children.push(
  ...
  new Paragraph({
    ...
    children: [new TextRun({ text: "ChanakyaTrade CLI", font: "Arial", size: 44, color: C.teal })],
  }),
  new Paragraph({
    alignment: AlignmentType.CENTER,
        ...
        default: new Header({
          children: [
            new Paragraph({
              ...
              spacing: { before: 0, after: 120 },
              children: [
                new TextRun({ text: "ChanakyaTrade — ChanakyaTrade CLI", font: "Arial", size: 18, color: C.navy, bold: true }),
...
const OUTPUT = "/Users/brij-home/Desktop/ChanakyaTrade/chanakya-trade/docs/chanakya-trade-testing-guide.docx";
