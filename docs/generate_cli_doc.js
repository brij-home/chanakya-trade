// generate_cli_doc.js — ChanakyaTrade CLI Feature Reference
...
const coverPage = [
  ...
  new Paragraph({
    ...
    children: [run("ChanakyaTrade", { bold: true, size: 72, color: C.navy })],
    spacing: { after: 120 },
  }),
  new Paragraph({
    alignment: AlignmentType.CENTER,
    children: [run("ChanakyaTrade CLI", { bold: true, size: 48, color: C.teal })],
    spacing: { after: 240 },
  }),
  new Paragraph({
    alignment: AlignmentType.CENTER,
    ...
    headers: {
      default: new Header({
        children: [new Paragraph({
          children: [
            run("ChanakyaTrade  |  ChanakyaTrade CLI — Feature Reference", { size: 16, color: C.gray }),
...
const OUTPUT = "/Users/brij-home/Desktop/ChanakyaTrade/chanakya-trade/docs/chanakya-trade-feature-reference.docx";
Packer.toBuffer(doc).then((buffer) => {
  fs.mkdirSync("/Users/brij-home/Desktop/ChanakyaTrade/chanakya-trade/docs", { recursive: true });
