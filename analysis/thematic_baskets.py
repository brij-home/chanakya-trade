...
THEMATIC_BASKETS: dict[str, ThematicBasketMetadata] = {
    "mayer_100_baggers": ThematicBasketMetadata(
        ...
        symbols=[
            "KAYNES", "DIXON", "SYRMA", "DATAPATTNS", "ZENTEC", "MTARTECH", "CYIENTDLM",
            "AETHER", "TATVA", "FINEORG", "MEDANTA", "KIMS", "NEWGEN", "RATEGAIN",
            "MAPMYINDIA", "CEINFO", "RADICO", "JUPITERWAG", "TITAGARH"
        ],
    ),
    "lynch_garp_fast_growers": ThematicBasketMetadata(
        ...
        symbols=[
            "TRENT", "POLYCAB", "KEI", "RRKABEL", "MAXHEALTH", "MANKIND", "CHOLAFIN",
            "PERSISTENT", "COFORGE", "KPITTECH", "VBL", "DMART", "JUBLFOOD", "TITAN", "SOLARINDS"
        ],
    ),
    "jhunjhunwala_operating_leverage": ThematicBasketMetadata(
        ...
        symbols=[
            "HAL", "BEL", "MAZDOCK", "COCHINSHIP", "GRSE", "BDL", "TITAGARH", "TEXRAIL",
            "JUPITERWAG", "BHEL", "CGPOWER", "ABB", "SIEMENS", "TATASTEEL", "JSWSTEEL", "HINDALCO"
        ],
    ),
    "canslim_high_momentum": ThematicBasketMetadata(
        ...
        symbols=[
            "BSE", "MCX", "CDSL", "ANGELONE", "TRENT", "DIXON", "HAL", "BEL",
            "PREMIERENE", "WAAREEENER", "SUZLON", "INOXWIND", "IREDA", "PERSISTENT", "COFORGE"
        ],
    ),
    "order_book_powerhouses": ThematicBasketMetadata(
        ...
        symbols=[
            "HAL", "BEL", "MAZDOCK", "COCHINSHIP", "GRSE", "BDL", "TITAGARH", "RVNL",
            "IRFC", "RAILTEL", "BHEL", "KEC", "KALPATPOWR", "TECHNOE", "PRAJIND", "ISGEC", "NCC", "LT"
        ],
    ),
    "value_migration_leaders": ThematicBasketMetadata(
        ...
        symbols=[
            "BSE", "MCX", "SUZLON", "INOXWIND", "IREDA", "KAYNES", "DIXON", "SYRMA",
            "PREMIERENE", "WAAREEENER", "ZOMATO", "POLICYBZR", "MAXHEALTH", "MANKIND", "NEULANDLAB"
        ],
    ),
}
