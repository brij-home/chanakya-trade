...
<p align="center">
  <img src="docs/images/app-analysis.png" alt="ChanakyaTrade — agentic AI trading platform for Indian stocks with multi-agent analysis" width="800" />
</p>
...
Both stay authenticated. Currently the last-connected broker becomes primary for all operations. Explicit data/execution routing is planned ([#129](https://github.com/brij-home/chanakya-trade/issues/129)).
...
**In progress:** multi-session UI ([#110](https://github.com/brij-home/chanakya-trade/issues/110)) . dual-broker mode ([#129](https://github.com/brij-home/chanakya-trade/issues/129)) . portfolio-aware personalisation ([#118](https://github.com/brij-home/chanakya-trade/issues/118), [#119](https://github.com/brij-home/chanakya-trade/issues/119), [#121](https://github.com/brij-home/chanakya-trade/issues/121)) . web search for agents ([#149](https://github.com/brij-home/chanakya-trade/issues/149))

**Planned:** app order placement UI ([#130](https://github.com/brij-home/chanakya-trade/issues/130)) . ML prediction analyst ([#145](https://github.com/brij-home/chanakya-trade/issues/145)) . ensemble meta-model ([#146](https://github.com/brij-home/chanakya-trade/issues/146)) . TradingView webhooks . SEBI compliance layer . memory improvements ([#122](https://github.com/brij-home/chanakya-trade/issues/122))

See [open issues](https://github.com/brij-home/chanakya-trade/issues).
...
See [CONTRIBUTING.md](CONTRIBUTING.md). Most wanted: broker integrations ([#80](https://github.com/brij-home/chanakya-trade/issues/80)), app order placement UI ([#130](https://github.com/brij-home/chanakya-trade/issues/130)), integration tests ([#79](https://github.com/brij-home/chanakya-trade/issues/79)).
...
Agentic trading uses autonomous AI agents that independently gather data, analyze markets, and make trading decisions -- rather than a single LLM answering questions. ChanakyaTrade runs 7 specialized agents (technical, fundamental, options, news, sentiment, sector, risk) that work in parallel, then debate before producing a final recommendation.

**How is this different from a trading chatbot?**
Trading chatbots take your question and return an answer. ChanakyaTrade's agents proactively gather data using tools (live quotes, options chains, FII/DII flows, news), analyze it independently, then engage in structured multi-round debate. The architecture mirrors how an institutional research desk operates -- multiple analysts with different specializations feeding into a portfolio manager.
...
No. ChanakyaTrade is an open-source research tool. All trading decisions are yours. See disclaimer below.
